...
export function ProductFilter({
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      {/* Mobile: Compact Dropdown & Horizontal Scroll bar */}
      <div className="md:hidden space-y-3">
        <div className="flex items-center gap-2">
          <label htmlFor={selectId} className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-slate-500">
        ...
        <div className="relative">
          <select
            ...
            className="w-full rounded-xl border border-slate-200 bg-white py-3 pl-4 pr-10 text-sm font-medium text-slate-900 shadow-sm focus:border-sky-600 focus:outline-none focus:ring-4 focus:ring-sky-100"
          >
            <option value="all">
